...
| `scripts/drill-watch.py`                         | syncs progress; QUIT, SHUT IT DOWN, idle teardown         | either destroy exception, or a phase             |
| `drill/server/src/activity.ts`                   | what counts as a human being here                         | anything touching the idle clock                 |
